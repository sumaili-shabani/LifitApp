...
class DynamicPieChartPaiementCourse extends StatefulWidget {
  const DynamicPieChartPaiementCourse({super.key});

  @override
  State<DynamicPieChartPaiementCourse> createState() => _DynamicPieChartPaiementCourseState();
}

class _DynamicPieChartPaiementCourseState extends State<DynamicPieChartPaiementCourse> {
  ...
  getIdConnected() async {
    ...
    futureData = ApiService.fetchPieData("passager_mobile_stat_paiement_course_mode/${idUser.toInt()}");
