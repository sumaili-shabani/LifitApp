class CourseModel {
  ...
  factory CourseModel.fromMap(Map<String, dynamic> json) => CourseModel(
    ...
    departLongitude: json["depart_longitude"],
    departLatitude: json["depart_latitude"],
    arriveeLongitude: json["arrivee_longitude"],
    arriveeLatitude: json["arrivee_latitude"],
    ...
    lonDepart: json["lonDepart"],
    latDestination: json["latDestination"],
    lonDestination: json["lonDestination"],
